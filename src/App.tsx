      ...
      <div className="relative min-h-screen overflow-hidden bg-slate-100">
        ...
        <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col px-6 pb-16 pt-16 lg:px-10">
          <header className="mb-16 space-y-12">
            <div className="inline-flex items-center gap-3 rounded-full border border-indigo-100 bg-white/70 px-5 py-2 text-sm font-medium text-slate-600 shadow-sm backdrop-blur">
              <Sparkles className="h-4 w-4 text-indigo-500" />
              <span>Key Stage 3 Maths • British English</span>
            </div>
            ...
            <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr),320px]">
              <div className="rounded-3xl border border-white/70 bg-white/85 p-10 shadow-xl backdrop-blur">
                ...
                <p className="mt-6 text-lg leading-relaxed text-slate-600">
                  Sharpen your reasoning with curated question sets, clear explanations, and a calm interface inspired by British classrooms.
                </p>
                <div className="mt-8 grid gap-4 text-sm sm:grid-cols-3">
                  <div className="rounded-2xl border border-indigo-100 bg-indigo-50/70 p-4 shadow-sm">
                    ...
                    <p className="mt-2 text-slate-600">Explore {topicCount} focused topics without overwhelming menus.</p>
                  </div>
                  <div className="rounded-2xl border border-emerald-100 bg-emerald-50/70 p-4 shadow-sm">
                    ...
                    <p className="mt-2 text-slate-600">Receive British English explanations to keep learning precise.</p>
                  </div>
                  <div className="rounded-2xl border border-amber-100 bg-amber-50/70 p-4 shadow-sm">
                    ...
                    <p className="mt-2 text-slate-600">Build streaks and see which strands deserve another go.</p>
                  </div>
                </div>
              </div>

              <div className="flex flex-col justify-between rounded-3xl border border-indigo-200 bg-gradient-to-br from-indigo-900 via-indigo-800 to-slate-900 p-10 text-white shadow-xl">
                <div>
                  <span className="text-sm uppercase tracking-[0.3em] text-indigo-200">Quick facts</span>
                  <h2 className="mt-4 text-4xl font-semibold">{TARGET_QUESTION_COUNT}-question sessions</h2>
                  <p className="mt-4 text-indigo-100">
                    Each round blends problem solving, reasoning, and fluency so you can revise in short bursts.
                  </p>
                </div>
                <div className="mt-10 grid gap-4 text-sm">
                  <div className="flex items-center justify-between rounded-2xl bg-white/10 px-5 py-3">
                    <span>Total questions curated</span>
                    <span className="font-semibold text-white">{totalQuestionCount}</span>
                  </div>
                  <div className="flex items-center justify-between rounded-2xl bg-white/10 px-5 py-3">
                    <span>Typical revision time</span>
                    <span className="font-semibold text-white">8 minutes</span>
                  </div>
                  <div className="flex items-center justify-between rounded-2xl bg-white/10 px-5 py-3">
                    <span>Designed for</span>
                    <span className="font-semibold text-white">Years 7–9</span>
                  </div>
                </div>
              </div>
            </div>
